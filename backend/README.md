...
## Project Structure
    ...
    ├── testapiautoconnecto_55739  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_55739`
...
2. Clone this repo and `cd testapiautoconnecto_55739`
